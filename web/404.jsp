...
<style>
    ...
    .div2{
        width:499px; height:169px;
        position: absolute;
        bottom: 150px;
        left: 550px;
        background:url(https://www.daixiaorui.com/Public/images/txtbg404.png) no-repeat;
    }
    .div2 .div1{ width:390px; position:relative; top:30px; left:60px;color:#eee; font-size:16px;}

    .div2 .div1 p {margin:5px 0; line-height:18px;}

    .div2 .div1 .paddingbox { padding-top:15px;}

    .div2 .div1  p a { color:#eee; text-decoration:none;}

    .div2 .div1  p a:hover { color:#FC9D1D; text-decoration:underline;}
</style>
<div class="div2">
    <div class="div1">
        ...
        <p>》<a href="${ctx}/HomePageServlet">返回网站首页</a></p>
